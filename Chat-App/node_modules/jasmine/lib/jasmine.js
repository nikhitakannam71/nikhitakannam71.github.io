var path = require('path'),
    util = require('util'),
    glob = require('glob'),
    exit = require('jasmine/lib/exit'),
    CompletionReporter = require('jasmine/lib/reporters/completion_reporter'),
    ConsoleSpecFilter = require('jasmine/lib/filters/console_spec_filter');
...
function Jasmine(options) {
  ...
  this.printDeprecation = options.printDeprecation || require('jasmine/lib/printDeprecation');
  this.specDir = '';
  this.specFiles = [];
  this.helperFiles = [];
